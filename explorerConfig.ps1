...
$app = @{pin = @("C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe","C:\tools\procexp64.exe","C:\tools\Procmon64.exe","C:\tools\tcpview64.exe", "C:\windows\system32\compmgmt.msc", "C:\windows\system32\eventvwr.msc"); unpin = @("Internet Explorer") }
